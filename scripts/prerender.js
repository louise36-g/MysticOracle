...
const STATIC_PAGES = [
  ...
  { path: '/tarot-card-reading', title: 'Personalized Tarot Readings – Love, Career & Spiritual Guidance', description: 'Choose from six tarot reading themes — love & relationships, career, spiritual growth, personal development & more. Personalized readings with classic tarot spreads. Start your reading now.' },
...
const STATIC_PAGES_FR = {
  ...
  '/tarot-card-reading': { title: 'Lectures de Tarot Personnalisées – Amour, Carrière & Guidance Spirituelle', description: 'Choisissez parmi six thèmes de lecture de tarot. Lectures personnalisées avec des tirages classiques. Commencez votre lecture maintenant.' },
