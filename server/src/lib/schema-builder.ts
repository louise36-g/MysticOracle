...
export const SITE_CONFIG: SiteConfig = {
  ...
  categoryUrls: {
    'Major Arcana': '/tarot/major-arcana-tarot-card-meanings',
    MAJOR_ARCANA: '/tarot/major-arcana-tarot-card-meanings',
    'Suit of Wands': '/tarot/suit-of-wands-tarot-card-meanings',
    SUIT_OF_WANDS: '/tarot/suit-of-wands-tarot-card-meanings',
    'Suit of Cups': '/tarot/suit-of-cups-tarot-card-meanings',
    SUIT_OF_CUPS: '/tarot/suit-of-cups-tarot-card-meanings',
    'Suit of Swords': '/tarot/suit-of-swords-tarot-card-meanings',
    SUIT_OF_SWORDS: '/tarot/suit-of-swords-tarot-card-meanings',
    'Suit of Pentacles': '/tarot/suit-of-pentacles-tarot-card-meanings',
    SUIT_OF_PENTACLES: '/tarot/suit-of-pentacles-tarot-card-meanings',
  },
};
