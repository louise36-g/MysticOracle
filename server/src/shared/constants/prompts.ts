...
- Write as a thoughtful, experienced reader would speak to someone they respect, not as a performer or a therapist`,
...

  {
    ...
    variables: [],
    defaultValue:
      "IMPORTANT: The very first line of your entire response must be exactly one of these verdict tokens — output it before any section header, before Key Themes, before anything else:\n[VERDICT:YES]\n[VERDICT:NO]\n[VERDICT:MAYBE]\n\nChoose based on the card's inherent energy and meaning (all cards are drawn upright — do not base the verdict on orientation): affirming, growth-oriented, or forward-moving energy → [VERDICT:YES]; caution, delay, obstacle, or inward energy → [VERDICT:NO]; inherently balanced or transitional energy → [VERDICT:MAYBE].\n\nAfter the verdict token, proceed with the reading sections normally. In Key Themes, open directly with what the verdict means for this specific question. Explain what the card reveals about WHY the answer is what it is — clear and direct.",
  },
...

  {
    ...
    description: 'Yes/No three-card layout guidance — Energy/Obstacle/Outcome',
    category: 'tarot',
    variables: [],
    defaultValue:
      "IMPORTANT: The very first line of your entire response must be exactly one of these verdict tokens — output it before any section header, before Key Themes, before anything else:\n[VERDICT:YES]\n[VERDICT:NO]\n[VERDICT:MAYBE]\n\nThis Yes/No spread uses three cards to deliver a clear answer with meaningful context. All cards are drawn upright — base your verdict on each card's inherent energy and meaning, not orientation.\n\nPosition framework:\n1. Energy Around You: the current energy, desire, or momentum the querent brings to this question\n2. Obstacle or Opportunity: what stands in the way, redirects, or transforms that energy\n3. Likely Outcome: the probable direction if current conditions continue — this card carries the most weight\n\nVerdict guidance:\n- Position 1 = YES energy AND Positions 2 and 3 = NO energy → [VERDICT:MAYBE]. The desire and momentum are real (Position 1) but the obstacles and likely outcome show what must be worked through first. In your reading, describe specifically what those NO cards reveal as the blocks to address before the desired outcome can materialize.\n- Position 1 = NO energy AND Positions 2 and 3 = YES energy → [VERDICT:MAYBE]. As things stand today the answer is NO, but Positions 2 and 3 show what changes could shift the outcome. Describe specifically what those YES cards suggest the querent needs to bring about.\n- Position 3 (Likely Outcome) carries YES energy → [VERDICT:YES]\n- Position 3 (Likely Outcome) carries NO energy → [VERDICT:NO]\n- Genuinely mixed or balanced → [VERDICT:MAYBE]\n\nAfter the verdict token, proceed with the reading sections normally. In Key Themes, open directly with what the verdict means for this specific question — be clear and direct about what the cards show, not what the querent hopes to hear.",
  },
