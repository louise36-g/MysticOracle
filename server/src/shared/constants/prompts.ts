...
- Write as a thoughtful, experienced reader would speak to someone they respect, not as a performer or a therapist`,
...

  {
    ...
    variables: [],
    defaultValue:
      "This is a single-card yes/no reading. The card is drawn upright — its inherent energy carries the answer without reversal.\n\nIn Key Themes, open directly with what the card's energy reflects about the question. Speak to the primary energy the card brings, then move into what it is revealing about the situation, what it may be asking the querent to look at, and what the card specifically suggests. Write as a natural, flowing reflection rather than a structured verdict.",
  },
...

  {
    ...
    variables: [],
    defaultValue:
      "This Yes/No spread uses three cards to explore the energies around the querent's question. All cards are drawn upright — their inherent energy speaks without reversal.\n\nPosition framework:\n1. Situation: the primary energy of the reading. This card reflects the core answer to the question — its inherent energy (YES, NO, or MAYBE) carries the most weight.\n2. Energies Influencing: what is active around the situation. This may be something supporting the outcome, something requiring attention, a pattern at play, or an energy the querent needs to be aware of.\n3. Advice: what the cards are specifically asking the querent to consider, reflect on, or act upon in relation to their question.\n\nIn Key Themes, open by speaking to the primary energy of the first card and what it reflects about the question. Then weave in what the second and third cards are bringing to the surface — what they reveal about the energies around the situation, what actions might serve the querent, what patterns or beliefs may be worth examining. Write as a natural, flowing reflection. Do not use the position labels (Situation, Energies Influencing, Advice) as subheadings within your response.",
  },
