...
export const defaultTranslations: Record<string, TranslationValue> = {
  ...
  // Home
  'home.title': { en: 'CelestiArcana', fr: 'CelestiArcana' },
  ...
  // Welcome Modal
  'welcome.step1.title': { en: 'Welcome to CelestiArcana', fr: 'Bienvenue sur CelestiArcana' },
  ...
  'credits.whatAre.description': {
    en: "Credits are your currency for tarot readings on CelestiArcana. There are no monthly fees or subscriptions — you simply purchase credits when you need them, and they never expire. Each reading type has a fixed cost, so you always know exactly what you're spending.",
    fr: "Les crédits sont votre monnaie pour les lectures de tarot sur CelestiArcana. Il n'y a pas de frais mensuels ni d'abonnements — vous achetez simplement des crédits quand vous en avez besoin, et ils n'expirent jamais. Chaque type de lecture a un coût fixe, vous savez donc toujours exactement ce que vous dépensez.",
  },
  ...
  'faq.gettingStarted.a3': {
    en: "Not at all. CelestiArcana is designed for everyone, from complete beginners to experienced readers. Simply ask your question and we'll handle the rest. Each reading explains the cards drawn, their traditional meanings, and how they relate to your specific situation.",
    fr: 'Pas du tout. CelestiArcana est conçu pour tout le monde, des débutants complets aux lecteurs expérimentés. Posez simplement votre question et nous nous occupons du reste. Chaque lecture explique les cartes tirées, leurs significations traditionnelles et comment elles se rapportent à votre situation spécifique.',
  },
  ...
  'faq.gettingStarted.a4': {
    en: "CelestiArcana does not predict the future. Tarot is a tool for reflection and insight, not divination. Our AI-generated interpretations offer symbolic guidance based on traditional card meanings. They're meant to help you think about your situation from new angles, not to tell you what will happen. The value lies in the perspective and self-reflection they inspire.",
    fr: "CelestiArcana ne prédit pas l'avenir. Le tarot est un outil de réflexion et d'insight, pas de divination. Nos interprétations générées par l'IA offrent une guidance symbolique basée sur les significations traditionnelles des cartes. Elles sont destinées à vous aider à réfléchir à votre situation sous de nouveaux angles, pas à vous dire ce qui va arriver. La valeur réside dans la perspective et l'auto-réflexion qu'elles inspirent.",
  },
  ...
  'faq.readings.a5': {
    en: 'CelestiArcana is fully available in English and French. You can switch languages anytime using the flag icon in the header. Your readings will be generated in your selected language.',
    fr: "CelestiArcana est entièrement disponible en anglais et en français. Vous pouvez changer de langue à tout moment en utilisant l'icône de drapeau dans l'en-tête. Vos lectures seront générées dans la langue sélectionnée.",
  },
  ...
  'faq.footer.disclaimer': {
    en: 'CelestiArcana is intended for entertainment and personal insight only. Readings are AI-generated and should not replace professional advice. By using this service, you agree to our',
    fr: "CelestiArcana est destiné uniquement au divertissement et à l'insight personnel. Les lectures sont générées par l'IA et ne doivent pas remplacer les conseils professionnels. En utilisant ce service, vous acceptez nos",
  },
  ...
  'about.story.p1': {
    en: 'CelestiArcana was born from a simple belief: that the timeless wisdom of tarot should be accessible to everyone, anytime they need guidance. We created a platform that honors the rich traditions of tarot reading while embracing the possibilities of artificial intelligence.',
    fr: "CelestiArcana est né d'une croyance simple : la sagesse intemporelle du tarot devrait être accessible à tous, à tout moment où ils ont besoin de guidance. Nous avons créé une plateforme qui honore les riches traditions de la lecture du tarot tout en embrassant les possibilités de l'intelligence artificielle.",
  },
  'about.story.p2': {
    en: "Our AI has been trained on centuries of tarot interpretation, symbolism, and meaning, allowing it to provide readings that are both insightful and personally relevant. Whether you seek clarity on love, career, or life's bigger questions, CelestiArcana is here to guide you.",
    fr: "Notre IA a été formée sur des siècles d'interprétation, de symbolisme et de signification du tarot, lui permettant de fournir des lectures à la fois perspicaces et personnellement pertinentes. Que vous cherchiez de la clarté sur l'amour, la carrière ou les grandes questions de la vie, CelestiArcana est là pour vous guider.",
  },
  ...
  'about.disclaimer': {
    en: 'CelestiArcana is intended for entertainment and personal reflection purposes only. Our AI-generated readings should not be considered professional advice for medical, legal, financial, or psychological matters.',
    fr: 'CelestiArcana est destiné uniquement à des fins de divertissement et de réflexion personnelle. Nos lectures générées par IA ne doivent pas être considérées comme des conseils professionnels pour des questions médicales, juridiques, financières ou psychologiques.',
  },
  'about.cta.ready': {
