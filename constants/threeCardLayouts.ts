...
export const THREE_CARD_QUESTIONS: Record<ThreeCardCategory, ThreeCardQuestion[]> = {
  general: [
    { id: '3gen1', textEn: 'What is this situation inviting me to understand about myself?', textFr: 'Que m\'invite cette situation à comprendre sur moi-même?' },
    { id: '3gen2', textEn: 'What am I ready to see that I couldn\'t see before?', textFr: 'Que suis-je prêt(e) à voir que je ne pouvais pas voir avant?' },
    { id: '3gen3', textEn: 'What part of me is being called to grow through this?', textFr: 'Quelle partie de moi est appelée à grandir à travers cela?' },
    { id: '3gen4', textEn: 'What am I holding onto that no longer serves me here?', textFr: 'À quoi est-ce que je m\'accroche qui ne me sert plus ici?' },
    { id: '3gen5', textEn: 'How can I approach this situation with more compassion for myself?', textFr: 'Comment puis-je aborder cette situation avec plus de compassion envers moi-même?' },
  ],
  love: [
    { id: '3love1', textEn: 'What is this connection revealing about my own patterns and needs?', textFr: 'Que révèle cette connexion sur mes propres schémas et besoins?' },
    { id: '3love2', textEn: 'What am I learning about myself through this relationship?', textFr: 'Qu\'est-ce que j\'apprends sur moi-même à travers cette relation?' },
    { id: '3love3', textEn: 'How do I contribute to the dynamics I experience in my relationships?', textFr: 'Comment est-ce que je contribue aux dynamiques que j\'expérimente dans mes relations?' },
    { id: '3love4', textEn: 'What part of me is seeking healing through this connection?', textFr: 'Quelle partie de moi cherche la guérison à travers cette connexion?' },
    { id: '3love5', textEn: 'What does my heart truly need that I\'ve been looking for in others?', textFr: 'De quoi mon cœur a-t-il vraiment besoin que j\'ai cherché chez les autres?' },
  ],
  career: [
    { id: '3car1', textEn: 'What does my work life reflect about my deeper sense of purpose?', textFr: 'Que reflète ma vie professionnelle sur mon sens profond du but?' },
    { id: '3car2', textEn: 'What strengths am I underutilizing or not fully acknowledging in myself?', textFr: 'Quelles forces est-ce que je sous-utilise ou ne reconnais pas pleinement en moi?' },
    { id: '3car3', textEn: 'What fear or belief might be limiting my professional growth?', textFr: 'Quelle peur ou croyance pourrait limiter ma croissance professionnelle?' },
    { id: '3car4', textEn: 'What would I pursue if I fully trusted my capabilities?', textFr: 'Que poursuivrais-je si je faisais pleinement confiance à mes capacités?' },
    { id: '3car5', textEn: 'What does success truly mean to me at this stage of my life?', textFr: 'Que signifie vraiment le succès pour moi à ce stade de ma vie?' },
  ],
  decision: [
    { id: '3dec1', textEn: 'What is this decision really asking me to face about myself?', textFr: 'Que me demande vraiment cette décision d\'affronter en moi-même?' },
    { id: '3dec2', textEn: 'What would choosing each path reveal about my values and priorities?', textFr: 'Que révélerait chaque choix sur mes valeurs et priorités?' },
    { id: '3dec3', textEn: 'What fears or beliefs are shaping how I see my options?', textFr: 'Quelles peurs ou croyances façonnent ma vision de mes options?' },
    { id: '3dec4', textEn: 'What would I need to believe about myself to decide with confidence?', textFr: 'Que devrais-je croire sur moi-même pour décider avec confiance?' },
    { id: '3dec5', textEn: 'What is this choice teaching me about what matters most to me?', textFr: 'Que m\'enseigne ce choix sur ce qui compte le plus pour moi?' },
  ],
  healing: [
    { id: '3heal1', textEn: 'What part of me is quietly calling for attention and care?', textFr: 'Quelle partie de moi appelle silencieusement l\'attention et le soin?' },
    { id: '3heal2', textEn: 'What pattern or belief am I ready to examine and release?', textFr: 'Quel schéma ou croyance suis-je prêt(e) à examiner et libérer?' },
    { id: '3heal3', textEn: 'What does feeling balanced and grounded mean to me right now?', textFr: 'Que signifie pour moi me sentir équilibré(e) et ancré(e) en ce moment?' },
    { id: '3heal4', textEn: 'What inner strength have I forgotten I possess?', textFr: 'Quelle force intérieure ai-je oublié que je possède?' },
    { id: '3heal5', textEn: 'How can I be a better friend to myself during this time?', textFr: 'Comment puis-je être un(e) meilleur(e) ami(e) pour moi-même pendant cette période?' },
  ],
};
