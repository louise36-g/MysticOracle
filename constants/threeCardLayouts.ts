...
export const THREE_CARD_LAYOUTS: Record<ThreeCardLayoutId, ThreeCardLayout> = {
  ...
  yes_no: {
    ...
    labelEn: 'Yes or No',
    labelFr: 'Oui ou Non',
    taglineEn: 'Ask a yes/no question and let three cards reveal the energies at play. The first card reflects the core answer; the second and third illuminate what is influencing the situation and what the cards are asking you to consider.',
    taglineFr: 'Posez une question oui/non et laissez trois cartes révéler les énergies en jeu. La première carte reflète la réponse principale ; les deux suivantes éclairent ce qui influence la situation et ce que les cartes vous invitent à considérer.',
    positions: { en: ['Situation', 'Energies Influencing', 'Advice'], fr: ['Situation', 'Énergies en jeu', 'Conseil'] },
    shortPositions: { en: ['Situation', 'Influencing', 'Advice'], fr: ['Situation', 'Influençant', 'Conseil'] },
  },
  custom: {
    id: 'custom',
    labelEn: 'Your Layout',
