...
const content = {
  en: {
    hero: {
      ...
      subtitle: 'Everything you need to know about MysticOracle'
    },
    disclaimer: {
      title: 'Important Notice',
      text: 'MysticOracle is for entertainment and personal reflection purposes only. Tarot readings provided here are generated by artificial intelligence and should not be considered professional advice (medical, legal, financial, or otherwise). The interpretations offer symbolic guidance and perspective, not predictions of the future. We encourage you to use these readings as a tool for self-reflection, not as a basis for important life decisions. Always consult qualified professionals for serious matters.'
    },
    gettingStarted: {
      title: 'Getting Started',
      q1: 'What is MysticOracle?',
      a1: "MysticOracle is an AI-powered tarot reading application. Each reading combines traditional tarot symbolism with personalized interpretation based on your question and the cards drawn. It's designed to offer guidance, perspective, and moments of reflection through the rich imagery of tarot.",
      ...
      a3: "Not at all. MysticOracle is designed for everyone, from complete beginners to experienced readers. Simply ask your question and we'll handle the rest. Each reading explains the cards drawn, their traditional meanings, and how they relate to your specific situation.",
      q4: 'Are the readings accurate predictions?',
      a4: "MysticOracle does not predict the future. Tarot is a tool for reflection and insight, not divination. Our AI-generated interpretations offer symbolic guidance based on traditional card meanings. They're meant to help you think about your situation from new angles, not to tell you what will happen. The value lies in the perspective and self-reflection they inspire.",
    ...
    readings: {
      ...
      a5: 'MysticOracle is fully available in English and French. You can switch languages anytime using the flag icon in the header. Your readings will be generated in your selected language.',
      credit: 'credit',
      credits: 'credits'
    },
    privacy: {
    ...
    footer: {
      disclaimer: 'MysticOracle is intended for entertainment and personal insight only. Readings are AI-generated and should not replace professional advice. By using this service, you agree to our',
  ...
  fr: {
    ...
    readings: {
      ...
      a5: "MysticOracle est entièrement disponible en anglais et en français. Vous pouvez changer de langue à tout moment en utilisant l'icône de drapeau dans l'en-tête. Vos lectures seront générées dans la langue sélectionnée.",
      credit: 'crédit',
      credits: 'crédits'
    },
    privacy: {
    ...
    footer: {
      disclaimer: "MysticOracle est destiné uniquement au divertissement et à l'introspection personnelle. Les lectures sont générées par l'IA et ne doivent pas remplacer les conseils professionnels. En utilisant ce service, vous acceptez nos",
