  ...
  return (
    <div className="flex flex-col items-center min-h-screen py-4 md:py-6 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center flex-1 w-full px-4">
        ...
        {/* Reading primer — shown just before the user clicks to reveal */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <p className="text-sm text-slate-300/90 text-center leading-relaxed">
            {language === 'en'
              ? "Situation and energy set the stage, and each card speaks with its own voice to light the way."
              : "La situation et l'énergie posent le décor, et chaque carte parle de sa propre voix pour éclairer le chemin."}
          </p>
        </motion.div>
