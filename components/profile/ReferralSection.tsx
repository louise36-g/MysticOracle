 ...
 * Displays referral code with copy, social share, email invite, and code redemption
 */
...
export const ReferralSection: React.FC<ReferralSectionProps> = ({
  ...
  const getTwitterText = () => {
    return language === 'en'
      ? `Join me on CelestiArcana! Use code ${referralCode} for 5 free credits ${signupUrl}`
      : `Rejoignez-moi sur CelestiArcana ! Code ${referralCode} pour 5 crédits gratuits ${signupUrl}`;
  };
      ...
      <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex gap-2 mb-3">
                  <div className="flex-1 bg-slate-800 border border-slate-700 rounded-lg px-4 py-2.5 font-mono text-purple-200 tracking-wider text-center">
                    {referralCode}
                  </div>
                  <button
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-lg transition-colors duration-200 text-sm ${
                      showEmailForm
                ...
                <AnimatePresence>
                  {showEmailForm && (
                    ...
                    >
                      <form onSubmit={handleSendInvite} className="mt-3 flex gap-2">
                        <input
                          type="email"
                          value={inviteEmail}
