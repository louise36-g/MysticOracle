 ...
 * Compact referral code with copy, social share, and email invite
 */

import React, { useState } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { Share2, Copy, CheckCircle, Mail, Send, Loader2 } from 'lucide-react';
import { useAuth } from '@clerk/clerk-react';
import { createShareUrl } from '../../utils/socialShare';
import { sendReferralInvite } from '../../services/api/user';
      ...
      <div className="space-y-3">
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-green-600/20 border border-green-500/30 hover:bg-green-600/40 text-green-400 hover:text-green-300 transition-colors text-sm font-medium"
            title="WhatsApp"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-blue-500/20 border border-blue-500/30 hover:bg-blue-500/40 text-blue-400 hover:text-blue-300 transition-colors text-sm font-medium"
            title="X"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
